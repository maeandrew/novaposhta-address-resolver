...
composer config repositories.core '{"type":"path","url":"../../var/core-package-openai","options":{"symlink":false,"versions":{"maeandrew/novaposhta-address-resolver":"0.4.0"}}}' --file="$local_manifest"
