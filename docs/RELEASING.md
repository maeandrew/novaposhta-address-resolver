...
The milestone versions are `v0.1.0` for M0/M1, `v0.2.0` for M2, `v0.3.0` for
M3, and the M4 polish line starts at `v0.4.0`. The first stable API will be
tagged `v1.0.0` after a public compatibility review.
